...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Product Categories",
  ...
  "description": "This template gets the categories on product page. Variable\u0027s value type should be array.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "categories",
    "displayName": "Product Categories Variable",
...
insiderObject.product.taxonomy = getData(data.categories) || '';
...
Created on 11/20/2020, 3:03:13 PM
